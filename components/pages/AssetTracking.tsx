...
import { 
  Laptop, ShieldCheck, FileText, QrCode, Lock, 
  AlertTriangle, CheckCircle2, Server, Factory, 
  Building2, Briefcase, ArrowDown, History
} from 'lucide-react';
...
export const AssetTracking: React.FC<AssetTrackingProps> = ({ onOpenDemo, onContact }) => {
      ...
      <section className="relative bg-white pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-slate-200 shadow-sm mb-8">
              ...
              <span className="text-xs font-semibold text-slate-600 uppercase tracking-widest">Asset Movement Control</span>
            </div>
            
            <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 leading-tight tracking-tight mb-8 max-w-4xl mx-auto">
              Secure Your High-Value Assets. <br />
            ...
            <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-2xl mx-auto">
              Track movement, prevent unauthorized removal, and maintain a complete audit trail of every IT and facility asset.
            </p>
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-10 border border-slate-200 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-600 mb-6">
                  Assets moving in and out of facilities are often tracked on paper or not tracked at all, leading to:
                </p>
                <ul className="space-y-4">
                  {[
                    "Theft or loss of laptops, tools, and equipment",
                    "Ghost assets that exist on books but not in the facility",
                    "Lack of accountability when items are damaged or lost",
                    "Compliance failures during inventory audits"
                  ].map((item, i) => (
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-2xl shadow-red-900/5 relative overflow-hidden border-2 border-movilance-red group">
               ...
               <div className="relative z-10">
                 <h2 className="text-2xl font-bold text-movilance-navy mb-6 flex items-center gap-3">
                    <div className="bg-movilance-red p-2 rounded-lg text-white shadow-lg"><Laptop className="w-6 h-6" /></div>
                    The Movilance Solution
                 </h2>
                 <p className="text-lg text-slate-600 leading-relaxed mb-6">
                   Movilance Asset Tracking creates a digital perimeter for your valuable equipment. Whether it's a laptop leaving for the day or a server being moved for maintenance, every movement is authorized and logged.
                 </p>
                 <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                   <p className="text-slate-700 font-medium italic border-l-4 border-movilance-red pl-4">
                     "We reduced annual asset shrinkage by 95% within the first quarter of implementation."
                   </p>
                 </div>
              </div>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-lg">Total control over movable assets.</p>
          </div>
            ...
            {[
              {
                ...
                features: ["Returnable (RGP) tracking", "Non-Returnable (NRGP) logging", "Paperless approval workflow"]
              },
              {
                icon: QrCode,
                title: "Asset Tagging",
                features: ["QR code / Barcode integration", "Scan-to-verify at gates", "Photo evidence capture"]
              },
              {
                icon: ShieldCheck,
                title: "Approval Workflows",
                features: ["Multi-level authorization", "Department head sign-offs", "Auto-rejection logic"]
              },
              {
                icon: Laptop,
                title: "Employee Asset Mapping",
                features: ["Assign laptops to employees", "Track long-term custody", "Exit clearance automation"]
              },
              {
                icon: Lock,
                title: "Gate Verification",
                features: ["Guard-assisted verification", "Mismatch alerts", "Block unauthorized exit"]
              },
              {
                icon: History,
                title: "Reconciliation & Alerts",
                features: ["Overdue return alerts", "Inventory reconciliation reports", "Movement history logs"]
              }
            ].map((cap, idx) => (
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
             ...
             <p className="text-slate-600 mt-4 text-lg">A secure chain of custody for every movement.</p>
          </div>
          ...
          <div className="grid md:grid-cols-5 gap-8 relative">
             ...
             {[
               { step: "01", title: "Request", desc: "Employee initiates asset movement request." },
               { step: "02", title: "Approve", desc: "Manager approves request digitally." },
               { step: "03", title: "Verify", desc: "Security scans asset at the gate." },
               { step: "04", title: "Exit/Entry", desc: "Movement logged with timestamp." },
               { step: "05", title: "Reconcile", desc: "Auto-closure on return (for RGP)." }
             ].map((item, idx) => (
          ...
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-6">
                {[
                  "Eliminate manual gate pass books",
                  "Faster asset processing at security gates",
            ...
            <div>
              ...
              <div className="space-y-6">
                {[
                  "Strict accountability for every asset",
                  "Tamper-proof digital audit trails",
                  "Automated policy enforcement for movement"
                ].map((b, i) => (
                   <div key={i} className="flex gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100">
