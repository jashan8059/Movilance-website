...
import { 
  Package, Truck, ClipboardCheck, RefreshCw, Scale, 
  ArrowRightLeft, AlertTriangle, CheckCircle2, Factory, 
  ShoppingCart, HardHat, Pill, Car, ArrowDown
} from 'lucide-react';
...
export const MaterialMovement: React.FC<MaterialMovementProps> = ({ onOpenDemo, onContact }) => {
      ...
      <section className="relative bg-white pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-slate-200 shadow-sm mb-8">
              ...
              <span className="text-xs font-semibold text-slate-600 uppercase tracking-widest">Material Movement Management</span>
            </div>
            
            <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 leading-tight tracking-tight mb-8 max-w-4xl mx-auto">
              Know Exactly What Moves <br />
            ...
            <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-2xl mx-auto">
              Track, verify, and control all inward and outward material movement with complete visibility, accuracy, and compliance.
            </p>
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-10 border border-slate-200 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-600 mb-6">
                  Material movement is a high-risk operational area. Manual or disconnected systems often lead to:
                </p>
                <ul className="space-y-4">
                  {[
                    "Loss or pilferage of valuable inventory",
                    "Incorrect quantity or weight records at the gate",
                    "Missing returnable items (RGP tracking issues)",
                    "Poor coordination between security, stores, and finance"
                  ].map((item, i) => (
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-2xl shadow-red-900/5 relative overflow-hidden border-2 border-movilance-red group">
               ...
               <div className="relative z-10">
                 <h2 className="text-2xl font-bold text-movilance-navy mb-6 flex items-center gap-3">
                    <div className="bg-movilance-red p-2 rounded-lg text-white shadow-lg"><Package className="w-6 h-6" /></div>
                    The Movilance Solution
                 </h2>
                 <p className="text-lg text-slate-600 leading-relaxed mb-6">
                   A single digital system to manage all material transactions at the gate, tightly integrated with security and store operations.
                 </p>
                 <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                   <p className="text-slate-700 font-medium italic border-l-4 border-movilance-red pl-4">
                     "We gained 100% visibility on returnable assets and stopped leakage at the gate immediately."
                   </p>
                 </div>
              </div>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-lg">Comprehensive control over every type of material transaction.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: Package,
                title: "Inward Material (GRN)",
                features: ["Track receipts against Purchase Orders", "Capture supplier & vehicle details", "Record condition & packaging"]
              },
              {
                icon: Truck,
                title: "Outward Dispatch",
                features: ["Validate against invoices/challans", "Purpose-based tagging", "Secure exit verification"]
              },
              {
                icon: RefreshCw,
                title: "Returnable Gate Pass (RGP)",
                features: ["Track repair or job work items", "Auto-balance for pending returns", "Alerts for overdue returns"]
              },
              {
                icon: ArrowRightLeft,
                title: "Inter-Unit Transfer",
                features: ["Track stock between plants", "Source & destination visibility", "Transit time logging"]
              },
              {
                icon: ClipboardCheck,
                title: "Inspection & Verification",
                features: ["Physical quantity checks", "Damage recording", "Photo evidence for discrepancies"]
              },
              {
                icon: Scale,
                title: "Weighbridge Integration",
                features: ["Automated weight capture", "Gross, tare, & net recording", "Variance analysis"]
              }
            ].map((cap, idx) => (
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
             ...
             <p className="text-slate-600 mt-4 text-lg">A structured workflow for total material accountability.</p>
          </div>
          ...
          <div className="grid md:grid-cols-5 gap-8 relative">
             ...
             {[
               { step: "01", title: "Arrival", desc: "Vehicle arrives; security logs entry." },
               { step: "02", title: "Verify Docs", desc: "Driver submits PO, Invoice, or Challan." },
               { step: "03", title: "Inspect", desc: "Store team verifies quantity & condition." },
               { step: "04", title: "Record", desc: "Transaction digitally logged & weighed." },
               { step: "05", title: "Clearance", desc: "Digital pass issued; vehicle exits." }
             ].map((item, idx) => (
          ...
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-6">
                {[
                  "Faster gate clearance with structured workflows",
                  "Better coordination between security and stores",
            ...
            <div>
              <h3 className="text-2xl font-bold text-movilance-navy mb-8 border-l-4 border-movilance-red pl-4">Control & Compliance</h3>
              <div className="space-y-6">
                {[
                  "Prevention of unauthorized material movement",
                  "Complete traceability of goods (RGP tracking)",
                  "Audit-ready transaction logs for inspections"
                ].map((b, i) => (
                   <div key={i} className="flex gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100">
                     <div className="bg-white rounded-full p-1 h-fit text-movilance-red shadow-sm border border-red-100"><AlertTriangle className="w-5 h-5" /></div>
                     <span className="text-slate-700 font-medium">{b}</span>
                   </div>
                ))}
              </div>
