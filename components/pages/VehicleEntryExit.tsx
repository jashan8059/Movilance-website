...
import { 
  Car, ScanLine, Clock, AlertTriangle, CheckCircle2, 
  ParkingSquare, Truck, ShieldCheck, Factory, Warehouse, 
  Building2, ArrowDown, MapPin, Scale
} from 'lucide-react';
...
export const VehicleEntryExit: React.FC<VehicleEntryExitProps> = ({ onOpenDemo, onContact }) => {
      ...
      <section className="relative bg-white pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-slate-200 shadow-sm mb-8">
              ...
              <span className="text-xs font-semibold text-slate-600 uppercase tracking-widest">Vehicle Access Control</span>
            </div>
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 leading-tight tracking-tight mb-8 max-w-4xl mx-auto">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-movilance-red via-red-500 to-orange-400">
                Identified. Authorized. Logged.
              </span>
            </h1>
            
            <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-2xl mx-auto">
              Automate your gates with ANPR, streamline parking, and track vehicle turnaround times with military-grade precision.
            </p>
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-10 border border-slate-200 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-600 mb-6">
                  Managing vehicle traffic manually creates bottlenecks and severe security blind spots:
                </p>
                <ul className="space-y-4">
                  {[
                    "Traffic congestion at main gates during peak hours",
                    "Unauthorized parking and vehicle abandonment",
                    "Inability to track time spent by logistics vehicles",
                    "No visual evidence for vehicle damage claims"
                  ].map((item, i) => (
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-2xl shadow-red-900/5 relative overflow-hidden border-2 border-movilance-red group">
               ...
               <div className="relative z-10">
                 <h2 className="text-2xl font-bold text-movilance-navy mb-6 flex items-center gap-3">
                    <div className="bg-movilance-red p-2 rounded-lg text-white shadow-lg"><Car className="w-6 h-6" /></div>
                    The Movilance Solution
                 </h2>
                 <p className="text-lg text-slate-600 leading-relaxed mb-6">
                   Turn your gates into intelligent checkpoints. Movilance integrates ANPR cameras and boom barriers to automate access while logging every detail.
                 </p>
                 <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                   <p className="text-slate-700 font-medium italic border-l-4 border-movilance-red pl-4">
                     "We reduced vehicle wait times by 60% while capturing license plate data for 100% of entries."
                   </p>
                 </div>
              </div>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-lg">From commercial trucks to employee cars, manage it all.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: ScanLine,
                title: "ANPR / LPR Integration",
                features: ["Auto-capture license plates", "Whitelist/Blacklist alerts", "Contactless entry"]
              },
              {
                icon: Truck,
                title: "Commercial Vehicle Flows",
                features: ["Weighbridge integration", "Dock scheduling", "Digital gate passes"]
              },
              {
                icon: ParkingSquare,
                title: "Parking Management",
                features: ["Real-time slot availability", "Reserved VIP parking", "Wrong parking alerts"]
              },
              {
                icon: Clock,
                title: "Turnaround Time (TAT)",
                features: ["Measure time inside premises", "Identify loading delays", "Optimize logistics flow"]
              },
              {
                icon: ShieldCheck,
                title: "Driver Verification",
                features: ["Driver license scanning", "Helper background checks", "Safety briefing log"]
              },
              {
                icon: Scale,
                title: "Material Reconciliation",
                features: ["Link vehicle to invoice", "Weight discrepancy alerts", "Proof of delivery"]
              }
            ].map((cap, idx) => (
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
             ...
             <p className="text-slate-600 mt-4 text-lg">A streamlined flow for every vehicle type.</p>
          </div>
          ...
          <div className="grid md:grid-cols-5 gap-8 relative">
             ...
             {[
               { step: "01", title: "Approach", desc: "ANPR camera reads license plate instantly." },
               { step: "02", title: "Verify", desc: "System checks pre-approval or prompts guard." },
               { step: "03", title: "Entry", desc: "Barrier opens; parking slot assigned." },
               { step: "04", title: "Operate", desc: "Loading/unloading or parking duration tracked." },
               { step: "05", title: "Exit", desc: "Auto-exit on valid gate pass or payment." }
             ].map((item, idx) => (
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              <h3 className="text-2xl font-bold text-movilance-navy mb-8 border-l-4 border-movilance-red pl-4">Logistics efficiency</h3>
              <div className="space-y-6">
                {[
                  "Optimize dock utilization and scheduling",
                  "Reduce vehicle waiting time by up to 40%",
                  "Digital proof of delivery eliminates disputes"
                ].map((b, i) => (
            ...
            <div>
              <h3 className="text-2xl font-bold text-movilance-navy mb-8 border-l-4 border-movilance-red pl-4">Perimeter Security</h3>
              <div className="space-y-6">
                {[
                  "Prevent unauthorized vehicles from entering",
                  "Video logs for every entry and exit event",
                  "Alerts for vehicles staying beyond authorized hours"
                ].map((b, i) => (
                   <div key={i} className="flex gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100">
      ...
      <section className="py-20 bg-slate-50 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
           ...
           <div className="flex flex-wrap justify-center gap-4">
              {[
                { icon: Warehouse, label: "Logistics Parks & Warehouses" },
                { icon: Factory, label: "Manufacturing Plants" },
                { icon: Building2, label: "Corporate Campuses" },
                { icon: MapPin, label: "Residential Townships" },
              ].map((ind, idx) => (
