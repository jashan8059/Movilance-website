...
import { 
  Banknote, Receipt, CheckCircle2, PieChart, Search, 
  FileText, AlertTriangle, Building2, Factory, 
  GraduationCap, HardHat, Stethoscope, ArrowDown, Wallet
} from 'lucide-react';
...
export const CashPurchase: React.FC<CashPurchaseProps> = ({ onOpenDemo, onContact }) => {
      ...
      <section className="relative bg-white pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-slate-200 shadow-sm mb-8">
              ...
              <span className="text-xs font-semibold text-slate-600 uppercase tracking-widest">Cash Purchase Control</span>
            </div>
            ...
            <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-2xl mx-auto">
              Digitally track petty cash purchases and spot buying with proper approvals, records, and audit-ready documentation.
            </p>
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-10 border border-slate-200 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-600 mb-6">
                  Cash and spot purchases are often unavoidable, but when managed manually they lead to:
                </p>
                <ul className="space-y-4">
                  {[
                    "Unapproved or excess spending without oversight",
                    "Missing bills and vouchers during reconciliation",
                    "No real-time visibility for finance or audit teams",
                    "High risk of leakage during internal and statutory audits"
                  ].map((item, i) => (
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-2xl shadow-red-900/5 relative overflow-hidden border-2 border-movilance-red group">
               ...
               <div className="relative z-10">
                 <h2 className="text-2xl font-bold text-movilance-navy mb-6 flex items-center gap-3">
                    <div className="bg-movilance-red p-2 rounded-lg text-white shadow-lg"><Banknote className="w-6 h-6" /></div>
                    The Movilance Solution
                 </h2>
                 <p className="text-lg text-slate-600 leading-relaxed mb-6">
                   Movilance Cash Purchase provides a structured digital workflow to record, approve, and track petty cash and spot purchases, ensuring transparency and financial control.
                 </p>
                 <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                   <p className="text-slate-700 font-medium italic border-l-4 border-movilance-red pl-4">
                     "We eliminated mystery expenses and reduced petty cash leakage by 100% in the first month."
                   </p>
                 </div>
              </div>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-lg">Financial discipline for every ad-hoc expense.</p>
          </div>
            ...
            {[
              {
                ...
                features: ["Log spot purchase requests", "Capture purpose & amount", "Department tagging"]
              },
              {
                icon: CheckCircle2,
                title: "Approval Workflow",
                features: ["Configurable approval levels", "Mobile authorization", "Status tracking"]
              },
              {
                icon: Receipt,
                title: "Voucher Management",
                features: ["Digital bill storage", "Photo upload via mobile", "Easy audit retrieval"]
              },
              {
                icon: PieChart,
                title: "Spend Tracking",
                features: ["Category-wise analysis", "Daily/Monthly limits", "Departmental budget tracking"]
              },
              {
                icon: Search,
                title: "Search & Reports",
                features: ["Filter by date or user", "Download finance reports", "Full transaction history"]
              },
              {
                icon: Wallet,
                title: "Cash Reconciliation",
                features: ["Opening/Closing balance", "Cash-in-hand tracking", "Reimbursement logs"]
              }
            ].map((cap, idx) => (
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
             ...
             <p className="text-slate-600 mt-4 text-lg">A transparent cycle from request to reconciliation.</p>
          </div>
          ...
          <div className="grid md:grid-cols-5 gap-8 relative">
             ...
             {[
               { step: "01", title: "Request", desc: "Employee logs purchase request with details." },
               { step: "02", title: "Approve", desc: "Manager authorizes the expense digitally." },
               { step: "03", title: "Purchase", desc: "Item purchased; bill/voucher uploaded." },
               { step: "04", title: "Verify", desc: "Finance/Admin verifies documents." },
               { step: "05", title: "Close", desc: "Transaction closed and archived." }
             ].map((item, idx) => (
          ...
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-6">
                {[
                  "Faster spot purchase approvals and processing",
                  "Reduced paperwork and manual petty cash registers",
                  "Clear tracking of all cash usage across teams"
                ].map((b, i) => (
            ...
            <div>
              <h3 className="text-2xl font-bold text-movilance-navy mb-8 border-l-4 border-movilance-red pl-4">Financial Control</h3>
              <div className="space-y-6">
                {[
                  "Prevention of unauthorized or excess spending",
                  "Improved expense transparency for audits",
                  "100% audit-ready digital cash purchase records"
                ].map((b, i) => (
                   <div key={i} className="flex gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100">
