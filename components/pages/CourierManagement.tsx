...
import { 
  Mail, Package, Send, Bell, Search, ClipboardCheck, 
  Users, CheckCircle2, AlertTriangle, Building2, 
  GraduationCap, Stethoscope, Briefcase, ArrowDown, Truck
} from 'lucide-react';
...
export const CourierManagement: React.FC<CourierManagementProps> = ({ onOpenDemo, onContact }) => {
      ...
      <section className="relative bg-white pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-slate-200 shadow-sm mb-8">
              ...
              <span className="text-xs font-semibold text-slate-600 uppercase tracking-widest">Courier & Mailroom Management</span>
            </div>
            
            <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 leading-tight tracking-tight mb-8 max-w-4xl mx-auto">
              Every Parcel Accounted For, <br />
            ...
            <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-2xl mx-auto">
              Digitally manage all inward and outward couriers with complete traceability, accountability, and zero confusion.
            </p>
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-10 border border-slate-200 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-600 mb-6">
                  Courier and mailroom operations are often handled manually or through scattered records, resulting in:
                </p>
                <ul className="space-y-4">
                  {[
                    "Lost or misplaced parcels within the facility",
                    "No clarity on who received or handed over an item",
                    "Delays in employee deliveries and notifications",
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-2xl shadow-red-900/5 relative overflow-hidden border-2 border-movilance-red group">
               ...
               <div className="relative z-10">
                 <h2 className="text-2xl font-bold text-movilance-navy mb-6 flex items-center gap-3">
                    <div className="bg-movilance-red p-2 rounded-lg text-white shadow-lg"><Mail className="w-6 h-6" /></div>
                    The Movilance Solution
                 </h2>
                 <p className="text-lg text-slate-600 leading-relaxed mb-6">
                   Movilance Courier Management digitizes the complete lifecycle of parcels and mail, ensuring that every item entering or leaving the facility is tracked and acknowledged.
                 </p>
                 <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                   <p className="text-slate-700 font-medium italic border-l-4 border-movilance-red pl-4">
                     "We eliminated lost parcel complaints and reduced front-desk clutter by digitizing the entire mailroom process."
                   </p>
                 </div>
              </div>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-lg">Streamline your reception and mailroom operations.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: Package,
                title: "Inward Courier Tracking",
                features: ["Log arrivals at gate/reception", "Capture docket & recipient details", "Real-time status updates"]
              },
              {
                icon: Send,
                title: "Outward Courier",
                features: ["Record outgoing parcels", "Select courier agency", "Track pickup confirmation"]
              },
              {
                icon: Truck,
                title: "Agency Registry",
                features: ["Master database of partners", "Track recurring delivery personnel", "Faster processing"]
              },
              {
                icon: ClipboardCheck,
                title: "Digital Handover",
                features: ["Digital signature capture", "Proof of delivery to employee", "Clear custody trail"]
              },
              {
                icon: Search,
                title: "Categorization & Search",
                features: ["Tag Internal/Domestic/International", "Search by docket or name", "Filter by agency"]
              },
              {
                icon: Bell,
                title: "Smart Notifications",
                features: ["Auto-notify employees on arrival", "Reminders for pickup", "Dispatch alerts"]
              }
            ].map((cap, idx) => (
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
             ...
             <p className="text-slate-600 mt-4 text-lg">Secure chain of custody from arrival to handover.</p>
          </div>
          ...
          <div className="grid md:grid-cols-5 gap-8 relative">
             ...
             {[
               { step: "01", title: "Arrival", desc: "Courier agent arrives; item details logged." },
               { step: "02", title: "Receipt", desc: "Item marked 'At Reception' or 'Security'." },
               { step: "03", title: "Notify", desc: "Employee gets instant arrival alert." },
               { step: "04", title: "Handover", desc: "Recipient collects item; digital signature." },
               { step: "05", title: "Outward", desc: "Dispatch process for outgoing mail." }
             ].map((item, idx) => (
          ...
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-6">
                {[
                  "Faster parcel handling and reduced confusion",
                  "Clear ownership at every stage of custody",
            ...
            <div>
              ...
              <div className="space-y-6">
                {[
                  "Complete traceability of all couriers",
                  "Reduced risk of loss, theft, or disputes",
                  "Audit-ready courier movement logs"
                ].map((b, i) => (
                   <div key={i} className="flex gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100">
