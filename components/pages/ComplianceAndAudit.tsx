...
import { 
  FileCheck, ShieldCheck, Lock, History, BarChart3, 
  FileWarning, Search, CheckCircle2, Scale, Building2, 
  Factory, Stethoscope, Briefcase, ArrowDown, Database,
...
export const ComplianceAndAudit: React.FC<ComplianceAndAuditProps> = ({ onOpenDemo, onContact }) => {
      ...
      <section className="relative bg-white pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-slate-200 shadow-sm mb-8">
              ...
              <span className="text-xs font-semibold text-slate-600 uppercase tracking-widest">Audit & Governance</span>
            </div>
            
            <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 leading-tight tracking-tight mb-8 max-w-4xl mx-auto">
              Always Audit-Ready. <br />
            ...
            <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-2xl mx-auto">
              Automatically capture, organize, and present operational and security records with structured logs and audit-ready documentation.
            </p>
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-10 border border-slate-200 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all duration-300">
              ...
              <div className="relative z-10">
                <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center gap-3">
                  <div className="bg-red-50 p-2 rounded-lg text-red-500 border border-red-100"><FileWarning className="w-6 h-6" /></div>
                  The Challenge
                </h2>
                <p className="text-slate-600 mb-6">
                  Organizations struggle with audits and compliance because of:
                </p>
                <ul className="space-y-4">
                  {[
                    "Missing or incomplete registers",
                    "Manual and inconsistent record keeping",
                    "Heavy dependency on security and admin staff",
                    "Time-consuming audit preparation",
                    "Risk of non-compliance observations and penalties"
                  ].map((item, i) => (
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-2xl shadow-red-900/5 relative overflow-hidden border-2 border-movilance-red group">
               ...
               <div className="relative z-10">
                 <h2 className="text-2xl font-bold text-movilance-navy mb-6 flex items-center gap-3">
                    <div className="bg-movilance-red p-2 rounded-lg text-white shadow-lg"><FileCheck className="w-6 h-6" /></div>
                    The Movilance Solution
                 </h2>
                 <p className="text-lg text-slate-600 leading-relaxed mb-6">
                   Movilance Compliance & Audit automatically records every operational and security transaction across the platform, converting day-to-day activities into structured, tamper-proof audit records.
                 </p>
                 <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                   <p className="text-slate-700 font-medium italic border-l-4 border-movilance-red pl-4">
                     "We moved from weeks of panic before audits to simply downloading a report in minutes."
                   </p>
                 </div>
              </div>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-lg">Governance built into every transaction.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              {
                icon: Database,
                title: "Automated Digital Logs",
                features: ["Visitor, vehicle, material, asset, and access records", "No manual registers or backdated entries", "Continuous data capture at source"]
              },
              {
                icon: FileText,
                title: "Centralized Audit Reports",
                features: ["Module-wise and date-wise reports", "One-click export for auditors", "Consistent and standardized formats"]
              },
              {
                icon: ShieldCheck,
                title: "Role Based Access Control",
                features: ["Controlled access for auditors and reviewers", "Data visibility based on role and responsibility", "Prevents unauthorized changes"]
              },
              {
                icon: History,
                title: "Historical Record Management",
                features: ["Long-term storage of logs and documents", "Easy retrieval during internal or statutory audits", "Supports trend and compliance analysis"]
              }
            ].map((cap, idx) => (
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
             ...
             <p className="text-slate-600 mt-4 text-lg">Effortless compliance flow.</p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 relative">
             ...
             {[
               { step: "01", title: "Data Capture", desc: "All movements and transactions recorded digitally in real time." },
               { step: "02", title: "Data Storage", desc: "Records are securely stored with timestamps and user details." },
               { step: "03", title: "Review", desc: "Admin or compliance teams review logs and reports as required." },
               { step: "04", title: "Audit", desc: "Auditors access structured reports without manual preparation." }
             ].map((item, idx) => (
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16">
            ...
            <div>
              <h3 className="text-2xl font-bold text-movilance-navy mb-8 border-l-4 border-movilance-red pl-4">Compliance & Governance Benefits</h3>
              <div className="space-y-6">
                {[
                  "Strong regulatory compliance posture",
                  "Improved transparency and accountability",
                  "Reduced audit observations and risks"
                ].map((b, i) => (
                   <div key={i} className="flex gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100">
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           ...
           <div className="grid md:grid-cols-4 gap-6">
              {[
                { icon: ClipboardList, role: "Audit", desc: "Reviewing logs and compliance records" },
                { icon: ShieldCheck, role: "Compliance", desc: "Ensuring regulatory adherence" },
                { icon: BarChart3, role: "Finance", desc: "Supporting statutory and internal audits" },
                { icon: UserCheck, role: "Management", desc: "Governance oversight and reporting" },
              ].map((team, idx) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
           ...
           <div className="flex flex-wrap justify-center gap-4">
              {[
                ...
                { icon: Scale, label: "Regulated Enterprises" },
              ].map((ind, idx) => (
