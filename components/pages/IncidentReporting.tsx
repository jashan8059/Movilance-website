...
import { 
  AlertTriangle, FileWarning, Search, CheckCircle2, ShieldAlert, 
  ClipboardList, Siren, Factory, Building2, HardHat, Stethoscope, 
  Warehouse, ArrowDown, Camera, FileText, Activity
} from 'lucide-react';
...
export const IncidentReporting: React.FC<IncidentReportingProps> = ({ onOpenDemo, onContact }) => {
      ...
      <section className="relative bg-white pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-slate-200 shadow-sm mb-8">
              ...
              <span className="text-xs font-semibold text-slate-600 uppercase tracking-widest">Incident & Safety Management</span>
            </div>
            
            <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 leading-tight tracking-tight mb-8 max-w-4xl mx-auto">
              Report Every Incident. <br />
            ...
            <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-2xl mx-auto">
              Digitally record safety incidents, security breaches, and operational issues with structured workflows and audit-ready documentation.
            </p>
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-10 border border-slate-200 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-600 mb-6">
                  Incidents are often reported manually or informally via calls, which leads to:
                </p>
                <ul className="space-y-4">
                  {[
                    "Delayed or missed incident reporting to key stakeholders",
                    "Incomplete details and missing photographic evidence",
                    "No clear ownership or follow-up actions for resolution",
                    "High risk during safety audits and legal reviews"
                  ].map((item, i) => (
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-2xl shadow-red-900/5 relative overflow-hidden border-2 border-movilance-red group">
               ...
               <div className="relative z-10">
                 <h2 className="text-2xl font-bold text-movilance-navy mb-6 flex items-center gap-3">
                    <div className="bg-movilance-red p-2 rounded-lg text-white shadow-lg"><Siren className="w-6 h-6" /></div>
                    The Movilance Solution
                 </h2>
                 <p className="text-lg text-slate-600 leading-relaxed mb-6">
                   Movilance Incident Reporting provides a centralized digital system to log, investigate, track, and close incidents with complete transparency and compliance control.
                 </p>
                 <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                   <p className="text-slate-700 font-medium italic border-l-4 border-movilance-red pl-4">
                     "We reduced incident resolution time by 50% and ensured 100% compliance during safety audits."
                   </p>
                 </div>
              </div>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-lg">Turn reactive responses into proactive safety management.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: AlertTriangle,
                title: "Digital Incident Logging",
                features: ["Log directly from security desk", "Capture location & timestamp", "Support for fire, theft, safety"]
              },
              {
                icon: Activity,
                title: "Severity Classification",
                features: ["Classify as Low/Medium/High/Critical", "Prioritize actions automatically", "Escalation matrix support"]
              },
              {
                icon: Camera,
                title: "Evidence Management",
                features: ["Upload photos & documents", "Secure digital storage", "Tamper-proof record linking"]
              },
              {
                icon: ClipboardList,
                title: "Investigation Workflow",
                features: ["Assign investigating authority", "Track status: Open to Closed", "Record root cause analysis"]
              },
              {
                icon: Search,
                title: "Search & Reports",
                features: ["Filter by category or date", "Download audit reports", "Historical incident logs"]
              },
              {
                icon: FileText,
                title: "Corrective Actions",
                features: ["Define CAPA plans", "Track implementation status", "Prevent recurrence"]
              }
            ].map((cap, idx) => (
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
             ...
             <p className="text-slate-600 mt-4 text-lg">A structured path from reporting to resolution.</p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 relative">
             ...
             {[
               { step: "01", title: "Report", desc: "Security logs incident with evidence." },
               { step: "02", title: "Assign", desc: "Routed to authority for investigation." },
               { step: "03", title: "Investigate", desc: "Root cause & corrective actions recorded." },
               { step: "04", title: "Close", desc: "Final remarks added; incident archived." }
             ].map((item, idx) => (
          ...
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-6">
                {[
                  "Faster incident reporting and response time",
                  "Clear accountability for every incident reported",
                  "Improved visibility into workplace safety trends"
                ].map((b, i) => (
            ...
            <div>
              <h3 className="text-2xl font-bold text-movilance-navy mb-8 border-l-4 border-movilance-red pl-4">Compliance & Legal</h3>
              <div className="space-y-6">
                {[
                  "Complete, tamper-proof incident documentation",
                  "Strong audit readiness for safety inspections",
                  "Improved overall safety compliance posture"
                ].map((b, i) => (
                   <div key={i} className="flex gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100">
                     <div className="bg-white rounded-full p-1 h-fit text-movilance-red shadow-sm border border-red-100"><FileWarning className="w-5 h-5" /></div>
                     <span className="text-slate-700 font-medium">{b}</span>
                   </div>
                ))}
              </div>
